...
class yelp_recom(MRJob):
    ...
    def top5_mapper(self, pair, similarity):
        '''
    ...
    def top5_reducer(self,name,others):
        '''
    ...
    def accuracy_mapper(self,name,similarity):
        ...
        for item in similarity[:5]:
            acc_top5 += item[-1][-1][0]
            num_top5 += item[-1][-1][-1]
        yield None, ((acc_total, num_total),(acc_top5,num_top5))
